...
(function ($) {
    $.fn.hovercard = function (options) {
        ...
        return this.each(function () {
            ...
            var hcImg = '';
            if(typeof options.cardImgSrc == "function"){
                hcImg = '<img class="hc-pic" src="' + options.cardImgSrc.call(this) + '" />';
            }else{
            ...
            var details = '';
            if(typeof options.detailsHTML == "function"){
                details = options.detailsHTML.call(this);
            }else{
                details = options.detailsHTML;
            }
            
            var hcDetails = '<div class="hc-details" >' + hcImg + details + '</div>';
